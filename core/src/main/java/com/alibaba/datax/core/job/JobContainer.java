...
import com.alibaba.datax.core.util.AlarmUtil;
...
public class JobContainer extends AbstractContainer {
    ...
    private void logStatistics() {
        ...
        LOG.info(alarminfo);
        AlarmUtil.sendAlarmToDefaultUser(this.jobId + "---" + "读写失败总数" + String.valueOf(CommunicationTool.getTotalErrorRecords(communication)));
